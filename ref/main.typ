...
#show: template.with(
  title: [资料汇编：汉字号数与点数的映射关系],
  date: [2026年5月7–17、22–24、29日，6月11、18日，8月5–14日],
  notes: [
    #for f in (
      "main.typ",
      "sources.typ",
    ...
    - 汉字通常是正方形，但也有*长体和扁体*，有些资料会专门描述各号数长体、扁体的横纵点数。本文件优先记录正方形的点数；特殊情况必须补充时，记录长体、扁体的纵向点数，即部分资料所谓「字号面」或「死面」之宽度对应的点数。
  ],
)
