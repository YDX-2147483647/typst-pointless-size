...
#let sources = (
  ...
  沪一厂1972: (
    ...
    notes: [
      ...
      该表是产品名录，所以很多点数、号数映射关系描述了多次。正方的字号前后一致；长体、扁体字号的纵向点数前后一致，而横向点数未必一致；正方、长体、扁体都有时，三者纵向点数一致。例如对应24页的四号仿宋是 $14$，对应28页的四号长仿宋是 $14 times 10.5$，二者纵向点数相同；而同样是小特，对应34页的长牟是 $42 times 36$，对应47页的隶书是 $42 times 63$，对应51页的黑变是 $42 times 31.5$，三种纵向点数相同但横向点数不同。另外，对应28页的五号长仿宋，不知为何只给了一个点数。
  ...
  沪二厂1980: (
    brief: [「铅字品种规格参照表」，上海字模二厂（湖北丹江文字六〇五厂）《字模与铅字样本》，1980年11月],
    via: [同@source:京新厂1981，r 提供影印 PDF],
    notes: [
      与@source:沪一厂1972 及@source:沪一厂1978 是同一地区不同厂不同年代的文件。
